...
/**
 * Standalone executable version of Example 2-1. Can be run locally over small
 * test data from the root repo dir via:
 * <p>
 * mvn compile exec:java -Dexec.mainClass=net.streamingbook.Example2_1
 * -Dexec.args="--inputFile=src/main/java/net/streamingbook/inputs.txt
 * --output=output" -Pdirect-runner
 * cat output-*
 * <p>
 * which will create and then dump one or more files in the root repo named
 * "output-NNNNN-of-MMMMMM".
 */
